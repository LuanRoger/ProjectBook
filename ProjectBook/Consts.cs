...
namespace ProjectBook
{
    public static class Consts
    {
        ...
        public static string FILE_FULL_NAME = APPLOCAL_FOLDER + USER_FILE_NAME + USER_FORMAT;
        ...
        public static string FONT_MONTSERRAT_EXTRABOLD = FONTS_FOLDER + "Montserrat-ExtraBold.ttf";
